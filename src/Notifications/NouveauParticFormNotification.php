...
class NouveauParticFormNotification
{
    /**
    ...
    public function notify()
    {
      ...
      ->setPassword('college159');
       ...
       $body = 'Hello, <p> un participant  au formation a éte   <span style="color:red;"> ajoutée</span>.</p>';

        // On construit le mail
        $message = (new Swift_Message('Consulter votre forum il y a un nouveau Participant au formation !!'))
      ->setFrom(['haweswebsite@gmail.com' => 'HAWESwebsite notifier'])
      ->setTo(['seifelislem.bensib@esprit.tn'])
