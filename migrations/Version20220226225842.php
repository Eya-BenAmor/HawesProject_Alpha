 ...
 */
final class Version20220226225842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE randonnee ADD couleur VARCHAR(7) DEFAULT NULL, CHANGE note note DOUBLE PRECISION NOT NULL');
    }
